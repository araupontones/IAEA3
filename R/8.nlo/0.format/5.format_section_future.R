...
#clean relevance ---------------------------------------------------------------
  ...
  categories <- c("Not aplicable", "Minor", "Moderate","Significant")


clean_future <- append_themes %>%
...
unique(clean_future$likert)     

#export ------------------------------------------------------------------------
export(clean_future, 'data/7.NLO/2.raw_formatted/Part_1_future.rds')
